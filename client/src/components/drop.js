...
export function Drop({ off, success, user }) {
    ...
    const onSubmit = async () => {
        ...
        try {
            const url = await fetch('https://ancient-scrubland-28193.herokuapp.com/get/s3url').then(
            ...
            if (url) {
                ...
                const response = await fetch('https://ancient-scrubland-28193.herokuapp.com/add', {
                    method: 'POST',
                    headers: {
